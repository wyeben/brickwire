import wave_light_apartment from '../../public/Profile-assets/wavelight-apartment.png';
...
export default function PropIntrest() {
  return (
    <div className='bg-[#F5F5F5] p-2 w-full mt-5'>
      <div className='flex justify-between flex-col md:flex-row'>
        <div className='flex '>
          <Image
            src={wave_light_apartment}
            alt='apartment image'
            width={160}
            height={160}
          ...
          />
          <div>
            <p className='font-medium text-lg'>Veronica Court</p>
      ...
      <div className='my-3 flex justify-between items-center'>
        <div>
          <h3 className='text-secondary font-bold mb-2'># 2.5 Million</h3>
      ...
      <div className='py-3 w-full'>
        <div className='flex items-center cursor-pointer'>
          <Link
            href={'property-description/651d62f82cab042aec4809d8'}
