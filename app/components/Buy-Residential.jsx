...
import img1 from '../../public/Howitworks-assets/img1.png';
import img2 from '../../public/Howitworks-assets/img2.png';
import img3 from '../../public/Howitworks-assets/img3.png';
import img4 from '../../public/Howitworks-assets/img4.png';

export default function Buy_Residential({ toggleHowItWorks }) {
  return (
    <section className='w-full px-5 md:px-[50px]'>
      <div className='grid grid-cols-1 md:grid-cols-2 lg:px-20'>
        ...
        <div className='md:pl-[50px] md:mb-5 mb-5 md:h-[435px] flex items-center flex-col justify-center'>
          ...
          {toggleHowItWorks ? (
            <p className='text-sm'>
              Elevate your investment portfolio by purchasing slots or cells in
              our shortlet apartments and enjoy the advantages of ownership,
