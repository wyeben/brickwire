...
export default function PropertyDescription(ctx) {
  ...
  const handleDelete = async () => {
    ...
    try {
      ...
      if (res.ok) {
        router.push("/admin/admin-main-090901028");
        console.log("property deleted successfully");
      } else {
        throw new Error("Trouble Deleting");
        console.log("property not deleted successfully");
      }
    } catch (error) {
      console.log(error);
    }
            ...
            <div className="w-full border border-[#E5E5E5] p-5 mb-10">
              ...
              <ul className="w-full text-sm">
                ...
                <li className="w-full flex justify-between mb-3">
                  ...
                  <div className="w-[20%]">
                    <p>{property.annualNetYield}</p>
                  </div>
                </li>
                <li className="w-full flex justify-between mb-3">
                  <p>Average Annual Appreciation</p>
                  <div className="w-[20%]">
                    <p>{property.averageAnnualAppreciation}</p>
                  </div>
                </li>
